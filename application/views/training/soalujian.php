    ...
    <div class="col-md-9">
        <div class="box box-success box-solid">
            ...
            <div class="box-body" style="overflow-y: scroll;height: 525px;">
                <form id="formSoal" role="form" action="<?php echo base_url(); ?>training/Ruang_ujian/jawab_aksi"
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $s->pertanyaan; ?>
                                        <input type='hidden' name='soal[]'
                                            value='<?php echo $s->id_soal_ujian; ?>' /><br />
                                        <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="A"
                                            required /> <?php echo $s->a; ?><br>
                                        <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="B"
                                            required /> <?php echo $s->b; ?><br>
                                        <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="C"
                                            required /> <?php echo $s->c; ?><br>
                                        <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="D"
                                            required /> <?php echo $s->d; ?><br>
                                        <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="E"
